...
def melt_pool_dimensionless (data):
    ...
    results_df['H_boiling_(J/mol)'] = 10*R*results_df['PROP LT (K)'] #recheck calculation 
...
def ET_NN(dimensionless_df):
    ...
    Results_ET_NN.to_csv('Results_NN_Cantor.csv', index=False) #change name of output file
